<html>
  <head>
    ...
    <style class="overlay-style">
      ...
      div img {
      --webkit-transition: all 0.5s; -moz-transition: all 0.5s; -o-transition: all  0.5s; display:block;box-shadow:0px 1px 1px #000;
      }
      ...
      div.info > p.desc {color:#999;font-size:8px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;}
