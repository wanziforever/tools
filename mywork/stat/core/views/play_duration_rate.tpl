...
<html lang="nl">
  ...
  <body onLoad="init()">
    ...
    <div>
      ...
      <a class="btn btn-primary" href="playdurationrate?vender={{vender}}&to={{pre_to_day}}&intvl={{intvl}}">向前30天</a>
      <a class="btn btn-primary" href="playdurationrate?vender={{vender}}&to={{next_to_day}}&intvl={{intvl}}">向后30天</a>
    </div>
    </div>
  </body>
  </html>
