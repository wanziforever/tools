...
<html lang="nl">
  ...
  <body onLoad="init()">
    <div class="container">
      聚好看接口性能趋势<small>({{today}} {{week}})</small>
    ...
    <div class="container">
      <a class="btn btn-primary" href="trends_api?to={{pre_to_day}}&api={{api}}">向前1天</a>
      <a class="btn btn-primary" href="trends_api?to={{next_to_day}}&api={{api}}">向后1天</a>
      <a class="btn btn-default" href="trends">返回全部接口页面</a>
