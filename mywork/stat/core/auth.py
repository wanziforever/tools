...
from common.errors import AuthError, BadArgValueError
from Crypto.Cipher import AES
from base64 import urlsafe_b64decode, urlsafe_b64encode

from common.sac import SACService
from common.sac.ttypes import *
from common.sac.constants import *
...
def generate_token(expired, *parts):
    ...
    '''
    if len(parts) < 1:
        raise BadArgValueError('auth key')
